    ...
    <form name="payment_form" id="payment_form" method="post" action="TrnPayRequest.php">
        ...
        <table border="1">
            <tr>
                ...
                <td><input type="text" name="mid" value="900000000000008" /></td>
            </tr>
            <tr>
                <td><label for="secretKey"> Secret Key </label></td>
                <td><input type="text" name="secretKey" value="scrh0e0TZiA6J6bKXvJs5Pme8CMavx0cNmi" /></td>
            </tr>
            <tr>
                <td><label for="saltKey"> Salt Key </label></td>
                <td><input type="text" name="saltKey" value="sal9XIXl94aP3ZC6ZFIki32ugGXBVJBfr" /></td>
            </tr>
            <tr>
                <td><label for="orderNo"> Order No. </label></td>
                <td><input type="text" name="orderNo" value="ORD<?php echo rand(11111111, 99999999) ?>" /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="mobileNo" value="9876543210" /></td>
            </tr>
            ...
            <tr>
                ...
                <td><input type="text" name="customerName" value="Graphite" /></td>
            </tr>
