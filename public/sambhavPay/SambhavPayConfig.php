...
/**
 * SambhavPay Class for PHP Integration Kit
 * 
 * @author    Rakesh Suthar
 * @copyright Copyright (c) 2022, SAMBHAVPAY PAYMENTS SOLUTIONS PRIVATE LIMITED https://sambhavpaycom.com/.
...
class SambhavPay {
    ...
    protected $PG_URL = 'https://pg.sambhavpay.com/api/seamless/txnReq';
    protected $PGStatusCheck_URL = 'https://pg.sambhavpay.com/apis/seamless/txnStatus';
