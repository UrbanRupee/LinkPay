...
@section('css')
    <style>
        /* ORANGE & CREAM THEME - API Documentation */
        ...
        .api-docs-container h1 { font-size: 2.25rem; color: var(--primary-orange); }
        .api-docs-container h2 { font-size: 1.75rem; border-bottom: 2px solid var(--primary-orange); padding-bottom: 0.5rem; color: var(--primary-orange); }
        .api-docs-container h3 { font-size: 1.5rem; color: var(--primary-orange); font-weight: 700; }
        .api-docs-container h4 { font-size: 1.25rem; color: #1F2937; }
        ...
        /* Styling for tables - ORANGE & CREAM THEME */
        ...
        /* Important notes - ORANGE & CREAM THEME */
...
@section('content')
<div class="container-fluid api-docs-container" style="background: var(--cream); padding: 2rem; min-height: 100vh;">
    <div class="box p-4">
        <h1>dhankubera API Documentation</h1>
        <p>Welcome to the dhankubera API documentation. This guide provides details on integrating with our payment gateway for PayIn, PayOut, Card Payments, and Wallet operations.</p>
        ...
        <ul>
            ...
            <li><strong>Base URL:</strong> <code>https://merchant.dhankubera.com/api/</code></li>
    ...
    <div class="box p-4 mt-3">
        ...
        <h4>Endpoint:</h4>
        <pre><code>POST https://merchant.dhankubera.com/api/pg/urbanpay/initiate</code></pre>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td><code>qr_required</code></td>
                    <td>Boolean</td>
                    <td>No</td>
                    <td>Set to <code>true</code> to generate QR code along with payment link. Default: <code>false</code></td>
                </tr>
            </tbody>
        </table>

        <h4>Example Request (Payment Link Only):</h4>
        <pre><code>{
    ...
    "mobile": "9112345322",
    "name": "Adarsh",
    "orderid": "dhankuberaPayin00001234",
    "callback_url": "https://YOURDOMAIN.COM/payin/callback"
}</code></pre>

        <h4>Example Request (With QR Code):</h4>
        <pre><code>{
    "token": "YOUR_API_TOKEN",
    "userid": "YOUR_USER_ID",
    "amount": "100",
    ...
    "qr_required": true
        ...
        <h4>Example Success Response (Payment Link):</h4>
        <pre><code>{
    "status": true,
    "message": "Payment initiated successfully",
    "url": "https://payments.dhankubera.in/pay/ABC123",
    "short_link": "https://pay.short/XYZ",
    "amount": "100",
    "tax": 1.77
}</code></pre>

        <h4>Example Success Response (With QR Code):</h4>
        <pre><code>{
    "status": true,
    "message": "Payment initiated successfully",
    "url": "https://payments.dhankubera.in/pay/ABC123",
    ...
    "tax": 1.77
        ...
        <p class="important-note"><strong>QR Code:</strong> When <code>qr_required</code> is <code>true</code>, the response includes a <code>qr_code</code> field containing a Base64-encoded PNG image. Display this QR code for customers to scan and pay instantly.</p>
    ...
    "message": "Error message detailing the failure"
        ...
        <p>dhankubera will send payment status updates to your <code>callback_url</code> after processing.</p>

        <h4>Callback Payload:</h4>
        <pre><code>{
    "status": "success",
    "client_txn_id": "dhankuberaPayin00001234",
    "utr": "409196790567",
    "amount": "100.00"
}</code></pre>
        ...
        <h3>1.3 Using QR Code Payments</h3>
        <p>QR Code payments provide a quick and convenient way for customers to pay using their mobile payment apps.</p>

        <h4>How to Display QR Code:</h4>
        <pre><code>// JavaScript Example
const response = await fetch('https://merchant.dhankubera.com/api/pg/urbanpay/initiate', {
    method: 'POST',
...
if (data.status && data.qr_code) {
    // Display QR code as image
    document.getElementById('qr-image').src = data.qr_code;
    
    // Also show payment link as fallback
    document.getElementById('payment-link').href = data.url;
}</code></pre>

        <h4>Best Practices:</h4>
        <ul>
            <li>✅ Always show both QR code and payment link for better customer experience</li>
            <li>✅ Display QR code prominently on payment page</li>
            <li>✅ Provide instructions: "Scan QR code using any UPI app to pay"</li>
            <li>✅ Show short_link for easy mobile sharing via WhatsApp/SMS</li>
            <li>✅ Auto-refresh payment status after QR code scan</li>
        </ul>

        <p class="important-note"><strong>Use Cases:</strong> QR codes are ideal for POS systems, retail stores, offline merchants, and mobile-first payment experiences.</p>

        <h3>1.4 Check PayIn Status</h3>
        <p>Check the current status of a PayIn transaction.</p>

        <h4>Endpoint:</h4>
        <pre><code>POST https://merchant.dhankubera.com/api/pg/urbanpay/checkstatus</code></pre>
    ...
    <div class="box p-4 mt-3">
        ...
        <h4>Endpoint:</h4>
        <pre><code>POST https://merchant.dhankubera.com/api/payout/initiate</code></pre>
    ...
    "id": ""
        ...
        <p>dhankubera will send payout status updates to your configured callback URL.</p>
    ...
    "utr": "688148704280"
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>String</td>
                    <td>Transaction ID generated by dhankubera.</td>
                </tr>
                <tr>
                    <td><code>utr</code></td>
                    <td>String</td>
        ...
        <h4>Endpoint:</h4>
        <pre><code>POST https://merchant.dhankubera.com/api/payout/checkstatus</code></pre>
    ...
    <div class="box p-4 mt-3">
        ...
        <h4>Endpoint:</h4>
        <pre><code>POST https://merchant.dhankubera.com/api/wallet</code></pre>
    ...
    <div class="box p-4 mt-3">
        ...
        <h4>Endpoint:</h4>
        <pre><code>POST https://merchant.dhankubera.com/api/card/initiate</code></pre>
    ...
    "status": "redirect",
    "transaction_id": 12345,
    "redirect_link": "https://secure.dhankubera.com/3ds/authenticate",
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td><code>transaction_id</code></td>
                    <td>Number</td>
                    <td>dhankubera transaction ID.</td>
                </tr>
                <tr>
                    <td><code>reference</code></td>
                    <td>String</td>
    ...
    <div class="box p-4 mt-3">
        ...
        <ul>
            <li>📧 <strong>Email:</strong> support@dhankubera.com</li>
            <li>🌐 <strong>Website:</strong> https://merchant.dhankubera.com</li>
            <li>💬 <strong>Live Chat:</strong> Available in merchant dashboard</li>
        </ul>

        <h3>Activation Steps</h3>
        <ol>
            <li>Contact dhankubera support to activate payment services</li>
